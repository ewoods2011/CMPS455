...
// and the stack segment
    ...
    printf("Zeroing out the address space and stack\n");

	//Read in page by page into main memory instaed of the entirety of the size
	// then, copy in the code and data segments into memory
	printf("Copying the code and data into memory\n");
...
/*
	Matt says this should work. Not sure why it doesn't.
*/
#ifdef FORLOOP
